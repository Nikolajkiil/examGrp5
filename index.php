...
<div class="container-fluid">
  <section class="window">
    <header>
      <div class="row">
        <div class="col-md-12 col-xs-12 img-size">
          <img class="img-float text-right logo-design" src="images/logo-hvid.png" alt="Dorthe Dalstrup logo" width="50%" height="auto">
          <img src="images/forside-billede.png" alt="Billede af Dorthe Dalstrup der træner" width="100%" height="100%">

          <button type="button" class="midt-placering btn btn-default btn-koeb-design">
            <div id="one">
              <a class="color-white" href="#one">Læs mere</a>
          </button>
...
<div class="row margin-space">
  ...
  <div class="col-md-4 col-xs-12">
    <iframe class="video-margin" width="100%" height="400px" src="https://www.youtube.com/embed/ahrsSJ_9tpA" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
...
<!-- Personanmeldelse 1 -->
      <div class="col-md-offset-2 col-md-2 col-sm-6 col-xs-12">
        <img class="img-margin" src="images/anmeldelser/karen.jpg" alt="Billede af karen" width="100%" height="100%">
...
<!-- Personanmeldelse 3 -->
      <div class="col-md-offset-1 col-md-2 col-sm-6 col-xs-12">
        <img class="img-margin" src="images/anmeldelser/liza.jpg" alt="Billede af Liza" width="100%" height="100%">
          <div class="glyphicon-placering">
            <span class="glyphicon glyphicon-star glyphicon-design"></span>
            <span class="glyphicon glyphicon-star glyphicon-design"></span>
            <span class="glyphicon glyphicon-star glyphicon-design"></span>
